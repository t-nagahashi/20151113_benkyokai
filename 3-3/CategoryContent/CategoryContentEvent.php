...
class CategoryContentEvent
{
   ...
   {   
        ...
        $html = $this->getHtmlCategoryContent($request, $response);
     ...
     * @return string
     */
    private function getHtmlCategoryContent(Request $request, Response $response)
    {
        $app = $this->app;
        ...
        // カテゴリコンテンツが登録されていない or 空で登録されている場合、レンダリングを変更しない
        ...
        return $newHtml = html_entity_decode($dom->saveHTML(), ENT_NOQUOTES, 'UTF-8');
    }
